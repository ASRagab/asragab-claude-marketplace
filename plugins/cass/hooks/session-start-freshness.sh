...
convos = db.get('conversations') if db.get('conversations') is not None else (sdb.get('conversations') if sdb.get('conversations') is not None else 0)
msgs = db.get('messages') if db.get('messages') is not None else (sdb.get('messages') if sdb.get('messages') is not None else 0)
